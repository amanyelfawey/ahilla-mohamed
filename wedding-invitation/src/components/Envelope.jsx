  ...
  return (
    ...
    >
      <div className="relative">
        <svg
          className="size-[72px] drop-shadow-[0_8px_20px_rgb(0_0_0/0.35)]"
          viewBox="0 0 80 80"
          aria-hidden="true"
        >
          <use href="#seal" />
...
function EnvelopePuff({ show }) {
  ...
  return (
    <div
      className="pointer-events-none absolute left-1/2 top-[52%] z-[6] -translate-x-1/2 -translate-y-1/2"
      aria-hidden="true"
    >
      {petals.map((p) => (
        <motion.span
    ...
    <AnimatePresence>
      {visible ? (
        ...
        >
          ...
          >
            <p className="mb-5 text-center font-script text-[1.35rem] text-gold-soft">
              To our dear guest
            </p>
            ...
            >
              ...
              <motion.div
                ...
                animate={
                  phase === "card" || phase === "exit"
                    ? {
                        y: "-8%",
                        boxShadow: "0 28px 60px -16px rgb(0 0 0 / 0.35)",
                      }
                    : phase === "flap"
                      ? { y: "10%" }
                      : { y: "40%" }
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 px-4 pb-4 text-center">
                  <p className="font-display text-[1.6rem] font-light leading-none text-cover">
                    {CONFIG.bride}
                  </p>
            ...
            >
              <span className="text-[0.62rem] tracking-[0.28em] uppercase text-gold-soft/70">
                Tap to open
              </span>
              <motion.span
