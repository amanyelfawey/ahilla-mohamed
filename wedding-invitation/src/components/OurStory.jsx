    ...
    >
      <div className="grid items-center gap-[clamp(2rem,6vw,4rem)] min-[820px]:grid-cols-[0.92fr_1.08fr]">
        <Reveal variant="scale" index={1}>
          <figure className="relative mx-auto w-full max-w-[440px]">
            ...
            >
              ...
              />
              <div
                className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,transparent_58%,rgb(47_38_41/0.18))]"
                aria-hidden="true"
              />
            </motion.div>
        ...
        <div className="mx-auto max-w-[34rem] text-center min-[820px]:text-left">
          <Reveal index={1}>
            <p className="text-[0.68rem] tracking-[0.42em] uppercase text-gold-deep">
              {story.eyebrow}
            </p>
          </Reveal>
          <Reveal index={2}>
          ...
          <Reveal index={4}>
            <p className="mt-6 text-[0.96rem] leading-[1.85] text-ink-soft">
              {story.body}
            </p>
          </Reveal>
          <Reveal index={5}>
            <p className="mt-5 text-[0.82rem] tracking-[0.12em] text-ink-faint italic">
              {story.closing}
            </p>
          </Reveal>
        </div>
