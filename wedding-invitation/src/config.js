...
export const CONFIG = {
  ...
  photos: {
    ...
    pair1:
      "https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=700&h=900&fit=crop&q=80",
    pair2:
      "https://images.unsplash.com/photo-1522673607200-164d1b6ce486?w=700&h=900&fit=crop&q=80",
  },
  ...
  seedWishes: [
    {
      name: "Nour & Karim",
      text: "Wishing you a lifetime as beautiful as the day you found each other.",
      date: "2026-08-02",
    },
    {
      name: "Layla Hassan",
      text: "Ahilla, seeing you this happy is the best gift. Congratulations to you both!",
      date: "2026-08-06",
    },
    {
      name: "The Saleh family",
      text: "May your home always be full of laughter, patience and love.",
      date: "2026-08-09",
    },
    {
      name: "Omar Fathy",
      text: "Mohamed, you found your person. Wishing you both endless joy.",
      date: "2026-08-11",
    },
    {
      name: "Hana & Youssef",
      text: "To many years of shared mornings and quiet, ordinary happiness.",
      date: "2026-08-14",
    },
    {
      name: "Aunt Mervat",
      text: "Rabbina yetammem lokom 3ala kheir. Wishing you a blessed union. 🤍",
      date: "2026-08-16",
    },
  ],
